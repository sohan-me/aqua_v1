...
import { useCustomerById, useUpdateCustomer } from '@/hooks/useApi';
...
export default function EditCustomerPage() {
  ...
  useEffect(() => {
    if (customer) {
      setFormData({
        ...
        contact_person: customer.data.contact_person || '',
        email: customer.data.email || '',
        phone: customer.data.phone || '',
        address: customer.data.address || '',
        city: customer.data.city || '',
        state: customer.data.state || '',
        country: customer.data.country || 'Bangladesh',
        postal_code: customer.data.postal_code || '',
        customer_type: customer.data.customer_type || 'individual',
        ...
        rating: customer.data.rating?.toString() || '',
  ...
  if (customerLoading) return <div className="flex justify-center items-center h-64">Loading...</div>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-500 bg-white"
                placeholder="e.g., Cash, Net 30, COD"
              />
            </div>
