                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Get notified about pond alerts and warnings</p>
                    </div>
                    <input
                      type="checkbox"
                      defaultChecked
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-yellow-700">
                          <p>Export all your fish farming data in CSV format.</p>
                        </div>
                        <div className="mt-4">
                          <button
                            type="button"
                ...
                <div className="bg-gray-50 rounded-md p-4">
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-sm text-gray-900">September 8, 2025</dd>
                    </div>
                    <div>
